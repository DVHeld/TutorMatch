...
$string['Aacronym'] = 'M';
$string['Afull'] = 'Mastered';
$string['Eacronym'] = 'P';
$string['Efull'] = 'Pending';
$string['Lacronym'] = 'L'; // NU - delete
$string['Lfull'] = 'Late'; // NU - delete
$string['Pacronym'] = 'P-'; // NU - delete
$string['Pfull'] = 'Present'; // NU - delete
$string['acronym'] = 'Acronym';
$string['absenteereport'] = 'Mastery report';
$string['add'] = 'Add';
...
$string['attendance:addinstance'] = 'Add a new TutorMatch activity';
$string['attendance:canbelisted'] = 'Appears in the roster';
$string['attendance:changeattendances'] = 'Changing Mastery';
$string['attendance:changepreferences'] = 'Changing Preferences';
$string['attendance:export'] = 'Export Reports';
$string['attendance:manageattendances'] = 'Manage Mastery';
$string['attendance:managetemporaryusers'] = 'Manage temporary users';
$string['attendance:takeattendances'] = 'Receiving Masteries';
$string['attendance:view'] = 'Viewing Masteries';
$string['attendance:viewreports'] = 'Viewing Reports';
$string['attendance:viewsummaryreports'] = 'View course summary reports';
$string['attendance:warningemails'] = 'Can be subscribed to emails with absentee users'; // NU - delete
$string['attendance_already_submitted'] = 'You may not self register attendance that has already been set.'; // NU - delete
$string['attendancedata'] = 'Mastery data';
$string['attendanceforthecourse'] = 'Mastery for the course';
$string['attendancegrade'] = 'Mastery grade';
$string['attendancenotset'] = 'You must set your mastery';
$string['attendancenotstarted'] = 'Mastery reporting has not started yet for this course';
$string['attendancepercent'] = 'Mastery percent';
$string['attendancereport'] = 'Mastery report';
$string['attendancesuccess'] = 'Mastery has been successfully reported';
$string['attendanceupdated'] = 'Mastery successfully updated';
...
$string['attrecords'] = 'Masteries records';
...
If "Set unmarked at end of session" any students who have not marked their mastery will be set to the unmarked status selected.';
$string['automarktask'] = 'Check for sessions that require auto marking';
$string['autorecorded'] = 'system auto recorded';
$string['averageattendance'] = 'Average mastery';
$string['averageattendancegraded'] = 'Average mastery';
...
$string['cannottakeforgroup'] = 'You can\'t assign mastery for group "{$a}"';
...
$string['changeattendance'] = 'Change mastery';
...
$string['confirmdeleteuser'] = 'Are you sure you want to delete user \'{$a->fullname}\' ({$a->email})?<br/>All of their TutorMatch records will be permanently deleted.';
$string['copyfrom'] = 'Copy mastery data from';
...
$string['enablewarnings_desc'] = 'This allows a warning set to be defined for mastery and email notifications to users when mastery drops below the configured threshold. <br/><strong>WARNING: This is a new feature and has not been tested extensively. Please use at your own-risk and provide feeback in the moodle forums if you find it works well.</strong>';
...
$string['resultsperpage_desc'] = 'Number of students displayed on each page';
...
$string['sessionsnotfound'] = 'There are no sessions in the selected timespan';
...
$string['setunmarked_help'] = 'If enabled in the session, set this status if a student has not marked their own mastery.';
...
$string['studentavailability_help'] = 'When students are marking their own mastery, the number of minutes after session starts that this status is available.
...
$string['studentscanmark'] = 'Allow students to record own mastery';
$string['studentscanmark_desc'] = 'If checked, teachers will be able to allow students to mark their own mastery.';
$string['studentscanmark_help'] = 'If checked students will be able to change their own mastery status for the session.';
$string['studentscanmarksessiontime'] = 'Students record mastery during session time';
$string['studentscanmarksessiontime_desc'] = 'If checked students can only record their mastery during the session.';
$string['studentscanmarksessiontimeend'] = 'Session end (minutes)';
$string['studentscanmarksessiontimeend_desc'] = 'If the session does not have an end time, how many minutes should the session be available for students to record their mastery.';
$string['submitattendance'] = 'Submit mastery';
$string['subnet'] = 'Subnet';
$string['subnetactivitylevel'] = 'Allow subnet config at activity level';
$string['subnetactivitylevel_desc'] = 'If enabled, teachers can override the default subnet at the activity level when creating a TutorMatch activity. Otherwise the site default will be used when creating a session.';
$string['subnetwrong'] = 'Mastery can only be recorded from certain locations, and this computer is not on the allowed list.';
$string['summary'] = 'Summary';
$string['tablerenamefailed'] = 'Rename of old attforblock table to mastery failed';
$string['tactions'] = 'Action';
$string['takeattendance'] = 'Update mastery';
...
$string['thirdpartyemailsubject'] = 'Mastery warning';
$string['thirdpartyemailtext'] = '{$a->firstname} {$a->lastname} mastery within {$a->coursename} {$a->aname} is lower than {$a->warningpercent} ({$a->percent})';
...
$string['warnafter'] = 'Number of topics before warning';
$string['warnafter_help'] = 'Warnings will only be triggered when the user has had their mastery set for at least this number of topics.';
$string['warningfailed'] = 'You cannot create a warning that uses the same percentage and number of topics.';
...
$string['includeabsentee'] = 'Include topic when calculating mastery report';
$string['includeabsentee_help'] = 'If checked this topic will be included in the mastery report calculations.';
$string['attendance_no_status'] = 'No valid status was available - you may be too late to record mastery.';
$string['studentmarked'] = 'Your mastery in this topic has been recorded.';
$string['topics'] = 'Topics';
$string['topicstable'] = 'Topics list';
